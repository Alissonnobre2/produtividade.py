...
# 1. Configuração da Página e Estilo (Tema Claro "Clean")
...
# Paleta para as categorias
cores_categorias = ["#6366F1", "#F59E0B", "#8B5CF6"]

# Dados extraídos do IR_2025 de Abril
...
# Dados Diários de Abril (30 dias)
...
# Dividindo os 30 dias de Abril em 4 semanas
...
# --- 5. PARTE DE BAIXO: 4 SEMANAS EM BARRAS AGRUPADAS ---
...
for i, sem in enumerate(semanas):
    with cols_semanas[i]:
        ...
        # Mantendo o range fixo para comparação visual entre as semanas
        fig_sem.update_yaxes(showgrid=True, gridcolor="#E5E7EB", range=[0, 15])
        st.plotly_chart(fig_sem, use_container_width=True)

# Legenda com quadradinhos para combinar com as barras
st.markdown(f"""
